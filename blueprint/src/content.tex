...
self-adjointness, membership of $i$ in its resolvent set, and the compact resolvent are
formalized and \texttt{sorry}-free; only the algebra representation remains to be built
(shared technology with Section~\ref{sec:torus}, where it is complete).
